...
```{r}
matrix_out_sample <- f_RunMatrixSim(nx,ny,nsteps=2000,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,K,
...
```{r}
matrix_out_rnorm <- f_RunMatrixSim(nx,ny,nsteps=2000,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,K,
...
```{r}
IBM_out <- f_RunIBM(nx,ny,nsteps=1000,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,heatmap_plot_int = 500)

IBM_out[[4]]
f_PlotAllHeatmapsIBM(IBM_out[[1]],IBM_out[[3]])
f_PlotOutput(IBM_out[[2]], kern_timesteps=seq(from=500,by=50,to=1000),kern_xlim = 25)
