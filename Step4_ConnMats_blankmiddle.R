...
temp_dir <- paste0("connmats_corner1_",experiment_name)
...
for(run_i in 2:28){
  ...
  # hab_params
  load(file=paste0(experiment_folder,"/habfiles_corner1/habparams_",mapID_i,".RData")) 
  list2env(x=hab_params,envir=environment()) 
  
  # load patch_dists
  load(file=paste0(experiment_folder,"/b",map_info$basemap_id,"/patchdists_b",map_info$basemap_id,"_p",map_info$popmap_id,"_corner1.RData"))
...
# htmlwidgets::saveWidget(prof_connmat,"prof_connmat.html")
# browseURL("prof_connmat.html")
}
