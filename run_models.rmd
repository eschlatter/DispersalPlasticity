...
f_PlotAllHeatmaps(clumpy_K_out$sim_melt,clumpy_K_out$patch_locations)
...
f_plot_gamma(all_patch$alpha[2],all_patch$theta[2],kern_xlim = 25)
f_plot_gamma(all_patch$alpha[1],all_patch$theta[1],kern_xlim = 25)
...
#save(IBM_out,K,file='model_runs/20251106_2.RData')
