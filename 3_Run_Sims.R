...
f_PlotOutputNew(by_t=sim_loop_out1$by_t,patch_locations=sim_loop_out1$patch_locations,nx=params$nx,ny=params$ny,sim_melt=sim_loop_out1$sim_melt,
...
a <- f_PlotAllHeatmapsDataTable(sim_loop_out1$sim_melt,sim_loop_out1$patch_locations,plot_int=nsteps)
