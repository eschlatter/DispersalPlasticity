...
matrix_out <- f_RunMatrixSim2(nx,ny,nsteps,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,K=60)

f_PlotOutput(matrix_out,plot_t=nrow(matrix_out),kern_xlim=5)
...
f_PlotOutput(IBM_out, plot_t=900:1000)
```
Run the IBM multiple times, to see if we get the same result
```{r}
b <- 2
