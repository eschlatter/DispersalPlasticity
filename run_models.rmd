...
v_alphas <- seq(from=0.01,to=5,length.out=4) # values the shape parameter can take
v_thetas <- seq(from=0.01,to=5,length.out=4) # values the scale parameter can take
alpha_start=2
theta_start=2
...
```{r}
matrix_out_sample <- f_RunMatrixSim(nx,ny,nsteps=2000,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,K=3,
...
```{r}
matrix_out_rnorm <- f_RunMatrixSim(nx,ny,nsteps=2000,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,K=10,
...
```{r}
IBM_out <- f_RunIBM(nx,ny,nsteps=1000,v_alphas,v_thetas,v_p,alpha_start,theta_start,p_start,mu,b,K=50,heatmap_plot_int = 500)
