...
hab_file="seascapes/2026_03_04/hab_1_pt"
...
nsteps <- 50000 # timesteps
# dispersal kernel is a gamma distribution, shape=alpha, scale=theta
v_alphas <- seq(from=0.5,to=1.5,length.out=3) # values the shape parameter can take
v_thetas <- seq(from=0.01,to=0.5,length.out=5) # values the scale parameter can take
...
save(sim_melt,by_t,hab_file,params,file="seascapes/2026_03_04/sim_out_10.RData")
