### Precalculate objects that are specific to a popmap (set of anemone locations) and navigation radius:
###   ref_mat (evaluating integral of kernel from each anemone to each anemone)
...
load(paste0("maps/b",basemapID,"/PopmapObjects_b",basemapID,"_p",popmapID,"_new.RData"))
...
save(ref_mat,file=paste0("maps/b",basemapID,"/NavradObjects_b",basemapID,"_p",popmapID,"_n=",nav_rad,".RData"))
